...
namespace Content.Shared.Input
{
    ...
    public static class ContentKeyFunctions
    {
        ...
        public static readonly BoundKeyFunction Sprint = "Sprint"; // Ported from Goobstation
        ...
        public static readonly BoundKeyFunction ResistGrab = "ResistGrab"; // Goobstation - Grab
