...
//
// Ported into the iss14 fork from Goobstation (Content.Goobstation.Shared.Sprinting).
//
// Fork notes:
...
public abstract class SharedSprintingSystem : EntitySystem
{
    ...
    private void OnDisarm(EntityUid uid, SprinterComponent sprinter, ref DisarmedEvent args)
    {
        ...
        _staminaSystem.TakeStaminaDamage(uid, sprinter.StaminaPenaltyOnShove, ignoreResist: false, logDamage: false);
