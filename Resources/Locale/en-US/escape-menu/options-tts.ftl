...
ui-options-tts-radio = Radio / comms
ui-options-tts-announcements = Announcements & AI
ui-options-tts-system = System (joins, server notices)
ui-options-tts-read-own = Read my own messages
